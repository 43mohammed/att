...
<head>
    ...
    <title>استعادة كلمة المرور - نظام الحضور</title>
        ...
        <div class="forgot-box">
            ...
            <form method="POST" action="/forgot-password">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" required value="{{ old('email') }}" placeholder="example@nbu.edu.sa أو example@stu.nbu.edu.sa">
                </div>
